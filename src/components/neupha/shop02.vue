  ...
  <el-container >
            ...
            <el-row style="margin-top: 10px;">
              <el-col :span="8">
                <el-form-item label="病历号：" >
                  <el-input v-model="searchForm01.CaseNumber" placeholder="输入病历号" ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
    ...
    <el-container direction="vertical" >
      <el-row style="background-color: #EAF1F5">
        <el-col :span="24">
          <el-button type="primary"  class="el-icon-success" @click="sendDrugs" :disabled="this.selItems.length==0">退药</el-button>
        </el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      sendDrugs(){
        let _this = this;
        this.$confirm('确认退回这 ' +  this.selItems.length + ' 种药品?', '提示', {
          type: 'warning',
          ...
          //修改状态
          deleteRequest('/neudoc/prescriptionDetailed/backDrugs/' + ids).then(resp=> {
            let json = resp.data;
            _this.$message({
              type: json.status,
              message: json.msg
      ...
      searchTemplate(){
        ...
        let url = "/neudoc/prescriptionDetailed/getPrescriptionBackByRegisterAndDate?caseNumber=" + this.searchForm01.CaseNumber + "&searchDate=" + this.searchForm01.SearchDate;
