       ...
       <el-table-column label="操作" align="left">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
              @click="handleReplay(scope.$index, scope.row)" icon="el-icon-sold-out">发票重打
            </el-button>
          </template>
        </el-table-column>
      </el-table>
...
<!-- 发票重打弹框---start -->
        <el-dialog title="发票重打(发票信息)" :visible.sync="dialogFormVisible" width="550px" align="center">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :inline="true" :model="formEdit" class="demo-form-inline" size="mini">
                ...
                <el-row :gutter="2">
                    ...
                    <div class="grid-content bg-purple">
                       <el-form-item label="">
                          <el-input  placeholder="ID" size="mini" v-model="ID02" readonly  v-if='false'></el-input>
                      </el-form-item>
                    </div>
                    </el-col>
                    ...
                    <div class="grid-content bg-purple">
                       <el-form-item label="">
                          <el-input  placeholder="UserID" size="mini" v-model="UserID02" readonly v-if='false'></el-input>
                      </el-form-item>
                    </div>
                    </el-col>
                    ...
                    <div class="grid-content bg-purple">
                       <el-form-item label="">
                          <el-input  placeholder="UserID" size="mini" v-model="RegistID02" readonly  v-if='false' ></el-input>
                      </el-form-item>
                    </div>
                    </el-col>
                    ...
                    <div class="grid-content bg-purple">
                       <el-form-item label="">
                          <el-input  placeholder="FeeType" size="mini" v-model="FeeType02" readonly  v-if='false' ></el-input>
                      </el-form-item>
                    </div>
                    </el-col>
                    ...
                    <div class="grid-content bg-purple">
                       <el-form-item label="">
                          <el-input  placeholder="UserID" size="mini" v-model="InvoiceNum_old" readonly  v-if='false'></el-input>
                      </el-form-item>
                    </div>
                    </el-col>
                  </el-row>
    ...
    <!--发票重打弹框---end -->
<el-input  placeholder="new_fph" size="mini" v-model="new_fph" readonly v-if='false'></el-input>
</div>
</template>
  ...
  export default{
    methods: {
      ...
      loadBlogs(page, count){
        ...
        //向服务器发 发票查询请求
        var url = "/neureg/invoice/invoice_query2?page=" + page + "&count=" + count + "&keywords=" + this.keywords;
      ...
      handleReplay(index, row){
        ...
        _this.InvoiceNum_old= row.InvoiceNum;
        _this.RealName02= row.RealName;
        _this.Money02= row.Money;
        _this.SettleName02 = row.SettleName;
        _this.ID02 = row.ID;
        _this.UserID02=row.UserID;
        _this.RegistID02=row.RegistID;
        _this.FeeType02=row.FeeType;
        _this.InvoiceNum02=this.new_fph;
      ...
      updateInvoice(){
        ...
        //向服务器发 发票重打请求
        postRequest("/neureg/invoice/invoice_replay", {InvoiceNum: this.InvoiceNum02, CaseNumber: this.CaseNumber02, Money:this.Money02, RegisterID:this.UserID02,RegistID:this.RegistID02,SettleId:this.SettleId02,FeeType:this.FeeType02,Back:this.ID02,ID: this.ID02}).then(resp=> {
              var json = resp.data;
              _this.$message({
                type: json.status,
                message: json.msg
      ...
      refresh(){
        ...
        getRequest("/neureg/invoice/bean01").then(resp=> {
            var json = resp.data;
            this.new_fph = parseInt(json.invoiceNum)+1;
        });
      }
    },
    mounted: function () {
